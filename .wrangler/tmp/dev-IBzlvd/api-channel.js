...
// .wrangler/tmp/bundle-mH8w2U/strip-cf-connecting-ip-header.js
...
// functions/api-channel.js
var api_channel_default = {
  async fetch(request, env2, ctx) {
    ...
    const kv = env2.CHANNEL_KV;
    const apiKey = env2.PUBLIC_YOUTUBE_API_KEY_2;
    ...
    const minimalData = {
      ...
      customUrl: item.snippet?.customUrl ? ensureAtPrefix(item.snippet.customUrl) : null,
      ...
      bannerExternalUrl: item.brandingSettings?.image?.bannerExternalUrl || null
    };
    ctx.waitUntil(
      storeToKV(kv, {
        id: minimalData.id,
...
__name(ensureAtPrefix, "ensureAtPrefix");
...
// .wrangler/tmp/bundle-mH8w2U/middleware-insertion-facade.js
var __INTERNAL_WRANGLER_MIDDLEWARE__ = [
  middleware_ensure_req_body_drained_default,
  middleware_miniflare3_json_error_default
];
var middleware_insertion_facade_default = api_channel_default;
...
// .wrangler/tmp/bundle-mH8w2U/middleware-loader.entry.ts
